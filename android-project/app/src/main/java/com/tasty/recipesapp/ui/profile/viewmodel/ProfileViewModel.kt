...
class ProfileViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _favorites = MutableLiveData<List<RecipeDTO>>()
    val favorites: LiveData<List<RecipeDTO>> = _favorites

    private val _selectedRecipe = MutableLiveData<RecipeDTO>()
    val selectedRecipe: LiveData<RecipeDTO> = _selectedRecipe
